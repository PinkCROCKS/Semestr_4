...
void print_status(int game_bank[3][3]){
    if (game_bank[0][0] && game_bank[0][1]){
        printf("----------On the Right Side Wolf and Goat----------\n");
        return;
    } if (game_bank[0][1] && game_bank[0][2]){
        printf("----------On the Right Side Goat and Cabbage----------\n");
        return;
    } if (game_bank[1][0] && game_bank[1][1]){
        printf("----------On the Left Side Wolf and Goat----------\n");
        return;
    } if (game_bank[1][1] && game_bank[1][2]){
        printf("----------On the Left Side Goat and Cabbage----------\n");
        return;
    }
}
